...
botui.message.add({
    ...
    return botui.message.add({
        delay:1000,
        loading: true,
        content:'I still did not get what you said, and I can see your frustration. Can you type again?'
    });
}).then(function(){
    return botui.action.text({
        action: {
    ...
    return botui.message.add({
        delay:6000,
        loading: true,
        content:'We are still retrieving your information. It is going to take a minute or so, and I can see your irritation. Please continue to wait.'
    });
}).then(function(){
    return botui.message.add({
        delay:10000,
